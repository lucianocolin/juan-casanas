    ...
    <>
      <div>
        ...
        <div className="about-me-body">
          ...
          <h2 className="about-me-section-title">Estudios</h2>
          <div className="about-me-studies-text">
            <p>
          ...
          <h2 className="about-me-section-title">Actividad en el campo</h2>
          <div className="about-me-farm-section">
            <div className="about-me-text">
              <p>
                ...
                (AACREA). Como miembro de la asociación me desempeño como Vocal
                de la Zona NOA.
              </p>
            </div>
          ...
          <h2 className="about-me-section-title">Política</h2>
          <div className="about-me-policy-section">
            <div className="about-me-text">
              <p>
                Inicié mi actividad política en el ámbito agropecuario en la
                <b> Federación Agraria Argentina</b>. Me involucré en el{" "}
                <b>paro agropecuario</b> patronal en Argentina de 2008 producido
                a causa de la <b>Resolución 125</b>. Luego participé en las
                <b> elecciones legislativas</b> del 28 de junio de 2009, como
                candidato a<b> Diputado Nacional.</b> <br />
                ...
                El 3 de abril de 2014 reasumí como <b>Diputado Nacional</b>{" "}
                nuevamente hasta el 2017.
              </p>
            </div>
            <div className="about-me-cards">
